...
<div class="card">
  ...
  <div class="header">
    ...
    <p> Creez un compte administrateur</p>
  </div>

  <!-- Formulaire d'inscription pour un admin -->
  <form method="post" action="index.php?page=admin&action=storeAdmin">
    <!-- Champ pour le nom -->
    <div class="field">
      <label>Nom</label>
  ...
  <!-- Pied de page de la carte avec un lien vers la page de connexion -->
  <div class="footer">
